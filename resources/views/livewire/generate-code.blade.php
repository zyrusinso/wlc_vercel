            ...
            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                <div class="row">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <div>
                            <button class="btn btn-info btn-md text-white" wire:click="bulkSendModal" >Bulk Send</button>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="text-center text-sm">
                                            <button class="btn btn-info btn-sm text-white" wire:click="sendShowModal({{ $item->id }})" <?= ($item->status == 'Used')? 'disabled': ''?>>
                                                Send to Buyer
                                            </button>
                                        </td>
                                    </tr>
                ...
                <div class="row justify-content-center">
                    @if ($buyersForm == true)
                        ...
                        <div class="col-12 col-xl-3">
                            <div class="mb-3">
                                <x-jet-label for="codeToSend" value="{{ __('How many code to send') }}" />
                                <x-jet-input id="codeToSend" type="text" class="{{ $errors->has('codeToSend') ? 'is-invalid' : '' }}"
                                            wire:model="codeToSend" autofocus />
                                <x-jet-input-error for="codeToSend" />
                            </div>
                        </div>
                        <hr/>
                        <div class="col-12 col-xl-4">
