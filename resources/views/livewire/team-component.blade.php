        ...
        <div class="col-md-3 col-sm-6 col-6">
            <div class="info-box bg-primary" style="border-radius: 30px !important;">
                ...
                <div class="info-box-content text-center">
                    <span class="info-box-number" style="font-size: 25px">{{ $this->networkListDataLatest(auth()->user()->endorsers_id)->full_name }} <i class="fas fa-eye" style="font-size: 12px"></i></span>
                    <div class="progress">
                        <hr/>
                    </div>
