...
class GenerateCode extends Component
{
    ...
    protected $messages = [
        ...
        'codeToSend.required' => 'How many code is Required!'
    ];
    ...
    public function searchMember(){
        ...
        if(!$data){
            $this->resetExcept(['modalBuyerFormVisible', 'buyerType', 'endorsers_id']);
            $this->addError('endorsers_id', 'User Endorser Not Found');
            return false;
        }
        ...
        $this->buyerFName = $data->first_name;
        $this->buyerLName = $data->last_name;
        $this->buyerMName = $data->middle_name;
    ...
    public function updatedBuyerType($value){
        ...
        if($value == 'members'){
            $this->resetValidation();
            $this->resetExcept(['modalBuyerFormVisible', 'buyersForm', 'buyerType']);
            $this->buyersForm = false;
        }
